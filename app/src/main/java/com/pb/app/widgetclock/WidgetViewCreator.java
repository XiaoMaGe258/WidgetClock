...
public class WidgetViewCreator implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        dateFormat = sharedPreferences.getString(context.getString(R.string.sp_date_format),"yyyy-MM-dd  EEE");
        fontName = sharedPreferences.getString(context.getString(R.string.sp_font),"default");
        timeTextSize = sharedPreferences.getInt(context.getString(R.string.sp_time_size),110);
        dateTextSize = sharedPreferences.getInt(context.getString(R.string.sp_date_size),24);
